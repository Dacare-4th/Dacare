...
function openModal(type) {
  ...
  if (type === "signup") {
    html = modalWrapper(`
      ...
      <div class="form-field"><label>Nickname</label><input class="form-input" id="signupName" type="text"></div> 
      <div class="form-field"><label>Email address</label><input class="form-input" id="signupEmail" type="text"></div>
      <div class="form-field"><label>Password</label><input class="form-input" id="signupPw" type="password" placeholder="8–16 characters, letters, numbers, and symbols"
      ></div>
...
function bindModalEvents() {
  ...
  if (signupSubmit) {
    signupSubmit.addEventListener("click", () => {
      ...
      const pwError = document.getElementById("signupPwError");
      const pw2Error = document.getElementById("signupPw2Error");
